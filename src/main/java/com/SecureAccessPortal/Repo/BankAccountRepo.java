...
public interface BankAccountRepo extends JpaRepository<BankAccount, Long> {
	...
	@Query("SELECT ba FROM BankAccount ba WHERE ba.customer.customerNo = ?1 AND ba.deletedFlag= :deletedFlag")
	List<BankAccount> findByCustomerNo(String customerNo, String deletedFlag);
