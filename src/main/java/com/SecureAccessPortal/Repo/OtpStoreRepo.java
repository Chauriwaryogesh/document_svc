...
public interface OtpStoreRepo extends JpaRepository<OtpStore, String> {
	...
	@Modifying
	@Query("UPDATE OtpStore o SET o.deletedFlag = :deletedFlag, o.updatedBy = :updatedBy, o.updatedTime = :updatedTime WHERE o.email = :email")
	void markAsDeletedByEmail(String email, String deletedFlag, String updatedBy, LocalDateTime updatedTime);
