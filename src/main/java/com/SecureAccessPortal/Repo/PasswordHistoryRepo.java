...
public interface PasswordHistoryRepo  extends JpaRepository<PasswordHistory, Long>{
    ...
    List<PasswordHistory> findTop5ByEmailAndIsCurrentFalseAndDeletedFlagOrderByCreatedTimeDesc(String email, String deletedFlag);
    ...
    List<PasswordHistory> findByEmailAndIsCurrentFalseAndDeletedFlagOrderByCreatedTimeAsc(String email, String deletedFlag);
